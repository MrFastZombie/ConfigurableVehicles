if settings.startup["tank-enable"].value then
    ...
    data.raw.car.tank.braking_force = settings.startup["tank-braking-force"].value
    ...
    if(settings.startup["tank-energy-per-hit"].value == 0) then data.raw.car.tank.energy_per_hit_point = 0.1
    else data.raw.car.tank.energy_per_hit_point = settings.startup["tank-energy-per-hit"].value end
end