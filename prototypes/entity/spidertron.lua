...
if settings.startup["spidertron-enable"].value then
    ...
    if(settings.startup["spidertron-energy-per-hit"].value == 0) then data.raw["spider-vehicle"]["spidertron"].energy_per_hit_point = 0.1
    else data.raw["spider-vehicle"]["spidertron"].energy_per_hit_point = settings.startup["spidertron-energy-per-hit"].value end
end