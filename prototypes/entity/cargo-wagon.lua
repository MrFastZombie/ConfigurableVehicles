if settings.startup["cargo-wagon-enable"].value then
    ...
    data.raw["cargo-wagon"]["cargo-wagon"].friction_force = settings.startup["cargo-wagon-friction"].value
    ...
    if(settings.startup["cargo-wagon-energy-per-hit"].value == 0) then data.raw["cargo-wagon"]["cargo-wagon"].energy_per_hit_point = 0.1
    else data.raw["cargo-wagon"]["cargo-wagon"].energy_per_hit_point = settings.startup["cargo-wagon-energy-per-hit"].value end
end